...
int returnBill(){
    char c, item, vegItem, nonvegItem, selectAgain;
    int billAmount=0;
    cout<<"--------------------------Welcome to Online FoodVerse--------------------------"<<endl;
    ...
    cout<<"Step 3 : Please press a to select veg item or press b to select noveg item"<<endl;
    cout<<"Step 4 : You will get your final Bill after your order confirm"<<endl;
    start:
    cin>>c;
    if(c=='s' || c=='S'){
        items:
